...
//initial state
  ...
  //ensure that our root reducer is returning the default state of each individual reducer
  ...
  //we dispatch an action & expect our root reducer to handle those actions by passing them into our individual reducers
